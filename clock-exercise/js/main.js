...
var Clock = function(clock){
    ...
    var moveClock = function(){
        this.seconds = this.container[this.numCont].querySelector("#seconds");
        this.minutes = this.container[this.numCont].querySelector("#minutes");
        this.hours = this.container[this.numCont].querySelector("#hours");
