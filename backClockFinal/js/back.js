...
var Clock = function(){
    ...
    var moveClock = function(){
        interval = setTimeout(
            function moveHandClock(){
                ...
                moveMinutes();
                showDigitaTime();
            interval = setTimeout(moveHandClock,1000);
            },1000);
    }
    ...
    var createDOMClock = function(){
        ...
        aRestart.setAttribute('onclick','restartClock(0,0,0)');
        ...
        aPause.setAttribute('onclick','pauseClock()');
        ...
        aResume.setAttribute('onclick','resumeClock()');
        ...
        aSetTime.setAttribute('onclick','setTimeClock()');
